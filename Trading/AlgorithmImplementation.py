...
def testallcoinbasetokens():
    ...
    outcomedict = {
        "NumberofTokensAnalysed": 18,
        "AverageHoursAssessed": 576,
        "TimeTaken": 0,
        "Key": "TestAllCoinbaseTokens",
        "UniqueCoinbaseTokenTime": 0
    }
    # Get a list of coinbase tokens
    coinbaselist = getallcoinbasetokens()
    # Save the time it took for this portion of the function
    uniquetokentime = timer()
    timetakensofar = uniquetokentime - start
    outcomedict["UniqueCoinbaseTokenTime"] = timetakensofar
    # Get only the list of tokens
    coinbaselist = coinbaselist["UniqueCoinbaseTokens"]
    # Store number of tokens
    outcomedict["NumberofTokensAnalysed"] = 19
    for token in coinbaselist:
        ...
        # Insert into testing database for AlgorithmOne Wargaming
    ...
    # Calculate the time taken
    timetaken = end - start
    # Store timetaken in outcome dictionary
